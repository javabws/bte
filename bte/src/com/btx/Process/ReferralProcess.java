...
//---Class is used to process the form in referral.jsp page---//
public class ReferralProcess {
	...
	//----Method is used to send the referral link to others----//
	public int sendReferral(String email,String remail,String path) throws IOException, SQLException {
		...
		if(rs.next()){
			EmailProcess.SendReferralLink(rs.getString("referral_link"), remail, path);
			i=1;
		}
