...
<head>
	...
	<title>Brokers | BinaryTradingExchange.com</title>
...
<body>
 ...
 String month[]={"January","February","March","April","May","June","July","August","September","October","November","December"};                 
                                ...
                                PreparedStatement p=c.prepareStatement("select * from forum_posts where status='proceed' AND discussion_id='3'");
                        	...
                        	<form action="forumrequest" method="post" >     
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <input type="hidden" name="id" id="id" value="3" required="required" >
