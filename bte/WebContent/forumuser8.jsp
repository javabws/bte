	...
	<!-- Static navbar -->
   	...
   	<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
				...
				<h4>Scams Discussion</h4>
				</li>
					<%
 String month[]={"January","February","March","April","May","June","July","August","September","October","November","December"};                 
                                Connection c=DbDriver.getConnection();
                                PreparedStatement p=c.prepareStatement("select * from forum_posts where status='proceed' AND discussion_id='8'");
                        	...
                        	<form action="forumrequest" method="post" >     
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <input type="hidden" name="id" id="id" value="8" required="required" >
