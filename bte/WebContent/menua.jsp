			...
			<div class="menu_section">
				...
				<ul class="nav side-menu">
					...
					<li><a href="admintradinghistory"><i class="fa fa-refresh"></i>Trading
							...
							<li><a href="adminwithdrawalrequest"><i class="fa fa-meh-o"></i>
							Withdrawal Requests	 </a></li>
							<li><a href="adminwithdrawndetails"><i class="fa fa-envelope-o"></i>
							Withdrawn Details	 </a></li>
							<li><a href="forumadmin"><i class="fa fa-envelope-o"></i>
							Forum	 </a></li>
