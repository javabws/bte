...
<head>
    ...
    <title>BinaryTradeXchange | Contact Support Histories</title>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="well" style="overflow: auto">
                                    ...
                                    Connection c=DbDriver.getConnection();
                                   	PreparedStatement p=c.prepareStatement("select * from contact_support order by time desc");
                                        ...
                                        <tbody>
                                         <%while(r.next())
                                            ...
                                            <tr class="even pointer">
                                                ...
                                                <td class="a-right a-right "><%=r.getDate("time")+" "+r.getTime("time") %></td>
                                                <td class=" "><%=r.getString("status") %></td>
                                                <td class=" last"><a href="admincontactview?id=<%=r.getInt("id") %>">View</a> </td>
                 </tr>
                                            <%} %>
