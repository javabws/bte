            ...
            <div class="right_col" role="main">
                <div class="min-heightfix">
                   ...
                   Forum Requests
                                ...
                                PreparedStatement p=c.prepareStatement("select * from forum_posts where status='waiting'");
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
				<ol class="user_comment com_appblck">
					<%while(r.next()) {%>
					...
					<li class="user_comment_list">
						...
						<p class="msg"><%=r.getString("posts") %>	<br/><h5> Requested by </h5> <h4> <%=r.getString("firstname") %></h4></p>
						<br/>
						<div class="comment_app">
							<h4><a href="forumadminproceed?id=<%=r.getInt("id") %>" class="green"  class="comment_approal">Approve</a>
							<a href="forumadmindelete?id=<%=r.getInt("id") %>" class="green" class="comment_block">Block</a>
						</h4></div>						
					</li>
