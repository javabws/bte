...
<head>
	...
	<title>Affiliates Forum | BinaryTradeExchange.com</title>
...
<body>
 ...
 String month[]={"January","February","March","April","May","June","July","August","September","October","November","December"};                 
                                ...
                                PreparedStatement p=c.prepareStatement("select * from forum_posts where status='proceed' AND discussion_id='9'");
                                PreparedStatement q=c.prepareStatement("select * from user_details where email=?");
                        	...
                        	<form action="forumrequest" method="post" >     
								<div class="form-group">
									<div class="col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <input type="hidden" name="id" id="id" value="9" required="required" >
