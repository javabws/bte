                               ...
                               if(r.next()) { btxsha b=new btxsha();%>
															<div class="" role="tabpanel"
																...
																<form class="form-horizontal form-label-left"
																	method="post" onsubmit="return automanual()"
																	action="Result.jsp">
																			...
																			<div id="myTabContent" class="tab-content">
																				<div role="tabpanel" class="tab-pane fade active in"
																					...
																					<INPUT TYPE="HIDDEN" NAME="method"
																						VALUE="<%=org.eclipse.jst.ws.util.JspUtils.markup("38")%>">
																					<INPUT TYPE="HIDDEN" NAME="securityToken85"
																						value="<%=b.shabtx()%>"> <INPUT
																						TYPE="HIDDEN" NAME="id"
																						value="<%=r.getInt("id")%>"> <INPUT
																						TYPE="hidden" NAME="walletID83"
																						value="OK516282756">

																					<div class="form-group">
																						<label
																							class="control-label col-md-3 col-sm-3 col-xs-12">Okpay
																							ID <span class="required">*</span>
																						</label>
																						<div class="col-md-6 col-sm-6 col-xs-12">
																							<INPUT TYPE="text" readonly="readonly"
																								NAME="receiver87"
																								value="<%=r.getString("okpay_id")%>">
																						</div>
																					</div>
																					<div class="form-group">
																						<label
																							class="control-label col-md-3 col-sm-3 col-xs-12">Currency
																							<span class="required">*</span>
																						</label>
																						<div class="col-md-6 col-sm-6 col-xs-12">
																							<INPUT TYPE="text" readonly="readonly"
																								NAME="currency89" value="USD" SIZE=20>
																						</div>
																					</div>

																					<div class="form-group">
																						<label
																							class="control-label col-md-3 col-sm-3 col-xs-12">Requested
																							amount <span class="required">*</span>
																						</label>
																						<div class="col-md-6 col-sm-6 col-xs-12">
																							<INPUT TYPE="text" readonly="readonly"
																								NAME="amount91"
																								value="<%=r.getString("requested_amount") %>">
																						</div>
																					</div>


																					<INPUT TYPE="HIDDEN" NAME="comment93"
																						value="<%=r.getString("user_email")%>"> <INPUT
																						TYPE="HIDDEN" NAME="isReceiverPaysFees95"
																						value="no"> <INPUT TYPE="HIDDEN"
																						NAME="invoice97"
																						value="inVoice<%=RandomStringUtils.random(10, true, true)%>">
																					...
																					<div class="form-group">
																						...
																						<div class="col-md-6 col-sm-6 col-xs-12">
																							<button type="button" name="submit"
																								...
																								data-target=".bs-example-modal-sm">Pay</button>
																								<a href="withdrawalreject?id=<%= id %>"><button type="button" name="submit"
																								class="btn btn-info btn-lg" >Reject</button></a>
