...
<head>
    ...
    <title>BinaryTradeXchange | Referral Stats</title>
                ...
                <div class="row">
                    ...
                    Refferral Stats
                        ...
                        UserBean u=(UserBean)session.getAttribute("userBean");
                                ...
                                PreparedStatement p=c.prepareStatement("select * from referral_list where referrer_id=? order by time desc");
                                p.setString(1, u.getEmail());
                                ResultSet r=p.executeQuery();
                               
                                %>
                      
                            <!-- /form datepicker --><div class="title_left">
                            <h3>
                    No. of refferrals
                </h3></div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        ...
                                        <%while(r.next()){ %>
                                            <tr class="even pointer">
                                                ...
                                                <td class=" "><%=r.getString("referrer_id") %></td>
                                                <td class=" "><%=r.getString("refer_id") %></td>
                                                <td class=" "><%=r.getDate("time")+" "+r.getTime("time") %></td>
                                                <td class=" "><%=r.getString("status") %></td>
                                ...
                                <% p=c.prepareStatement("select * from referral_process where referrer_id=? order by time desc");
                                p.setString(1, u.getEmail());
                                r=p.executeQuery(); %>  
                                <div class="x_content">
                                <div class="title_left">
